...
from pymolfold_min.predictors import ESM3Predictor, ESMFoldPredictor
...
def query_boltz_monomer(sequence: str, name: str = None):
    ...
    """
    import asyncio
    from pymolfold_min.predictors import Boltz2Predictor
...
def __init_plugin__(app=None):
    ...
    print(f"PymolFold_min v{__version__} loaded successfully!")
    return True
